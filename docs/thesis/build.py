...
DESC = {
 ...
 "lib/db/billboards/index.ts":"درِ ورودیِ لایهٔ دسترسی دادهٔ رسانه‌ها. هر مصرف‌کننده — چه مسیر API چه صفحهٔ جزئیات — از همین یک نشانی می‌خواند، پس منطق پرس‌وجو یک بار نوشته شده و تقسیم‌بندیِ درونی به بیرون نشت نمی‌کند.",
 ...
 "lib/db/billboards/mutations.ts":"هر نوشتنِ جدول رسانه‌ها: ساخت، ویرایش، ثبت و ارسالِ دوبارهٔ آگهی، و حذف با سنگِ‌قبر. هر نوشتنی که دیدِ بازدیدکننده را عوض کند، برچسب کش را هم باطل می‌کند.",
 "lib/db/billboards/core.ts":"واژگانِ مشترکِ دو نیمه: نگاشت ردیف پایگاه داده به رکورد دامنه، دو باریک‌سازیِ بیرونی (حذف شمارهٔ مالک و کوچک‌سازی برای کارت)، برچسب کش و تعریف «منتشرشده».",
 ...
 "lib/client/clipboard.ts":"نسخه‌برداری متن با مسیر جایگزین، چون واسط استاندارد مرورگر بیرون از بستر امن اصلاً وجود ندارد.",
