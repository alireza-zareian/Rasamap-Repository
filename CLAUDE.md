...
npm run build | lint
npm test          # 116 API tests on a production build (~18 s)
npm run test:e2e  # 8 browser flows over the installed Chrome; screenshots on failure
...
python3 scripts/build-og-fonts.py   # static TTFs for the share card (§30)
