...
const sections = [
  ...
  { title: "۲. خدمات ارائه‌شده", body: "رسامپ یک فهرست آنلاین از رسانه‌های تبلیغاتی محیطی است. ما تسهیل‌گر ارتباط بین تبلیغ‌دهندگان و صاحبان رسانه‌ها هستیم؛ رسانه‌ها متعلق به ما نیستند، اجاره و قرارداد مستقیماً بین دو طرف انجام می‌شود و رسامپ واسطهٔ مالی این معامله نیست." },
  ...
  { title: "۴. ثبت آگهی و پرداخت", body: "درآمد رسامپ از ثبت آگهی توسط صاحبان رسانه است. پلن رایگان پس از تأیید کارشناس منتشر می‌شود. پلن ویژه پس از تأیید واریز وجه توسط ادمین فعال شده و آگهی در ابتدای نتایج جستجو قرار می‌گیرد. در حال حاضر پرداخت آنلاین فعال نیست و تسویه به‌صورت دستی هماهنگ می‌شود." },
  ...
  { title: "۶. حریم خصوصی", body: "اطلاعات شخصی کاربران تنها برای ارائه خدمات استفاده می‌شود و به اشخاص ثالث فروخته نمی‌شود. وقتی کاربر روی «نمایش شمارهٔ تماس» یک رسانه کلیک می‌کند، این درخواست (حساب کاربر، رسانه، زمان و تعداد دفعات) برای پیگیری و سنجش تقاضا ثبت می‌شود و تنها برای تیم مدیریت رسامپ قابل مشاهده است؛ در اختیار صاحب رسانه یا هیچ شخص ثالثی قرار نمی‌گیرد. با استفاده از سرویس، کاربر با سیاست حریم خصوصی رسامپ موافقت می‌کند." },
  { title: "۷. محدودیت مسئولیت", body: "رسامپ پلتفرمی دانشگاهی-تجربی است. ما تلاش می‌کنیم اطلاعات دقیق ارائه دهیم اما ضمانت کامل صحت اطلاعات رسانه‌ها را نمی‌دهیم. کاربر باید پیش از هرگونه توافق با صاحب رسانه، اطلاعات را راستی‌آزمایی کند." },
