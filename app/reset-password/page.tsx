        ...
        <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 16, padding: 24, boxShadow: "0 24px 60px rgba(0,0,0,0.4)" }}>
          ...
          {step === 1 && (
            <form onSubmit={e => { e.preventDefault(); if (!loading) sendCode(); }}>
              <label htmlFor="reset-phone" style={{ fontSize: "0.78rem", color: "var(--text-muted)", display: "block", marginBottom: 6 }}>شماره موبایل حساب</label>
              <input id="reset-phone" value={phone} onChange={e => setPhone(toLatin(e.target.value))} type="tel" inputMode="tel" dir="ltr" lang="en" placeholder="09123456789" style={{ ...inp, textAlign: "left" }} />
